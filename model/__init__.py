...
# 新增：注册SAMIRNet
from model.SAMIRNet.model import SAMIRNet_Tiny, SAMIRNet_Small

__all__ = [
    'Unet', 'ALCNet', 'ACM', 'DNANet', 'RISTDnet', 'UIUNet', 
    'ISTDU_Net', 'RDIAN', 'ResUNet',
    'SAMIRNet_Tiny', 'SAMIRNet_Small'
]
